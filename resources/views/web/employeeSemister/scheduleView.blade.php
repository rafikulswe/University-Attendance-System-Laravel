            ...
            <div class="row">
                <div class="col-xs-12">
                    <section class="panel">
                        ...
                        <form class="form-horizontal form-bordered" action="{{route('approveEmployeeSchedule')}}" method="POST">
                            @csrf    
                            ...
                            <div class="form-group">
                                <div class="col-sm-9 col-sm-offset-3">
                                    ...
                                    <a href="{{route('employeeSemister')}}" class="btn btn-default">Back to List</a>
                                </div>
                            </div>
                        </form>
                    </div>
