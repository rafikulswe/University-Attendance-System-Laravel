                ...
                <section class="panel">
                        <div class="tab-content">
                            <div id="everything" class="tab-pane active">
                                <p class="total-results text-muted">All Supervisor's Attendance Notifications</p>
                                ...
                                <ul class="list-unstyled search-results-list" style="max-width: 100%!important;">
                                    ...
                                    <li>
                                        ...
                                        @endif
                                        <a href="{{route('viewEmpAttendance',$notification->id)}}">
                                    ...
                                    <li>
                                        ...
                                        @endif
                                        <a href="{{route('viewEmployeeSchedule',$semister->id)}}">
                                            <div class="result-data">
