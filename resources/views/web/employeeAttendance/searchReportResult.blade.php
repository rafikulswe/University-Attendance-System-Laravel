                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                <div class="col-sm-9 col-sm-offset-3">
                                    <a href="{{route('printReport', ['employee_id'=>$employee_id, 'date_from'=>$date_from, 'date_to'=>$date_to])}}" target="_blank" class="btn btn-default">PDF</a>
                                    <a href="{{route('attendanceReport')}}" class="btn btn-default">Search Again</a>
                                </div>
                            </div>
                        </div>
                    </section>
